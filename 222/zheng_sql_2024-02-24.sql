...
INSERT INTO `family_category` VALUES (202, 201, '郑某', '', 0, 1, 0, '长子', 'FFFFFF');
...
CREATE TABLE `family_category_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '类别组' ROW_FORMAT = Dynamic;
...
INSERT INTO `family_set` VALUES (153, 0, -100, 2, 0, '新加商品是否自动通过审核', 'isExamine', '1', '1：商户新添加的商品自动通过审核，0：要人工审核');
INSERT INTO `family_set` VALUES (154, 0, 0, 1, 0, '上传图片最大宽度', 'maxWidth', '700', '单位是像素');
INSERT INTO `family_set` VALUES (155, 0, 0, 1, 0, '上传图片最大高度', 'maxHeight', '700', '单位是像素');
INSERT INTO `family_set` VALUES (156, 0, 0, 1, 0, '商家LOGO最大宽度', 'logoWidth', '300', '单位是像素');
INSERT INTO `family_set` VALUES (157, 0, 0, 1, 0, '商家LOGO最大高度', 'logoHeight', '300', '单位是像素');
